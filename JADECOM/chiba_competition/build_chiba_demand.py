...
IN_CSV = Path("/Users/itotsubasa/Downloads/jadecom/4:6/千葉県/h03_12.csv")
OUT_CSV = BASE_DIR / "data" / "h03_12_町丁目別医療需要者数_main_with_age.csv"
...
def main() -> None:
    ...
    use = df[(df["都道府県名"] == "千葉県") & (df["男女"] == "総数") & (df["地域階層レベル"] == 4)].copy()

...
# パス
# =========================
TABLE_PATH = "/Users/itotsubasa/IdeaProjects/pythoN/JADECOM/佐々総合病院/競合分析/佐々総合病院周辺の町丁目_各医療施設利用数_KLA統合_tokyo_car30_match.xlsx"
SHP_DIR = "/Users/itotsubasa/IdeaProjects/pythoN/JADECOM/佐々総合病院/競合分析"
SHP_PATH = "/Users/itotsubasa/IdeaProjects/pythoN/JADECOM/佐々総合病院/競合分析/tokyo_car30_target_towns_from_r2ka13.shp"
OUT_DIR = "/Users/itotsubasa/IdeaProjects/pythoN/JADECOM/佐々総合病院/競合分析"
OUT_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_all.png")
OUT_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_all_result.csv")
OUT_TOP7_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_top7.png")
OUT_TOP7_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_top7_result.csv")
OUT_TOP7_ONLY_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_top7only.png")
OUT_TOP7_ONLY_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_top7only_result.csv")
OUT_TSUGE_PLUS5_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_sasa_plus5.png")
OUT_TSUGE_PLUS5_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car30_sasa_plus5_result.csv")
...
# =========================
TARGET_FACILITY = "佐々総合病院"

# =========================
# 部分一致を許す市区町村
# =========================
PARTIAL_MATCH_CITIES = set()
TOP_N = 7
...
def main() -> None:
    ...
    ax.set_title("佐々総合病院 車30分圏内: 町丁目別 医療機関勢力圏（最大人数・全対象施設）")
    ax.axis("off")
    ...
    ax2.set_title(f"佐々総合病院 車30分圏内: 町丁目別 勢力圏（上位{TOP_N}施設）")
    ax2.axis("off")
    ...
    ax3.set_title(f"佐々総合病院 車30分圏内: 町丁目別 勢力圏（上位{TOP_N}施設のみで再計算）")
    ax3.axis("off")
    ...
    # 11) 佐々総合病院 + 上位5施設（佐々を除外して上位抽出）で再計算
    ...
    ax4.set_title("佐々総合病院 車30分圏内: 勢力圏（佐々総合病院 + 上位5施設で再計算）")
    ax4.axis("off")
    ...
    print("対象施設(佐々+上位5):", selected_facilities)
    print("保存PNG(sasa_plus5):", OUT_TSUGE_PLUS5_PNG)
    print("保存CSV(sasa_plus5):", OUT_TSUGE_PLUS5_CSV)

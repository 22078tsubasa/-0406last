...
# パス
# =========================
TABLE_PATH = "/Users/itotsubasa/IdeaProjects/pythoN/JADECOM/佐々総合病院/競合分析/佐々総合病院周辺の町丁目_各医療施設利用数_KLA統合_tokyo_car20_match.xlsx"
...
OUT_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_all.png")
OUT_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_all_result.csv")
OUT_TOP7_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_top7.png")
OUT_TOP7_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_top7_result.csv")
OUT_TOP7_ONLY_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_top7only.png")
OUT_TOP7_ONLY_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_top7only_result.csv")
OUT_TSUGE_PLUS5_PNG = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_sasa_plus5.png")
OUT_TSUGE_PLUS5_CSV = os.path.join(OUT_DIR, "dominant_territory_sasa_car20_sasa_plus5_result.csv")
...
def main() -> None:
    ...
    ax.set_title("佐々総合病院 車20分圏内: 町丁目別 医療機関勢力圏（最大人数・全対象施設）")
    ax.axis("off")
    ...
    ax2.set_title(f"佐々総合病院 車20分圏内: 町丁目別 勢力圏（上位{TOP_N}施設）")
    ax2.axis("off")
    ...
    ax3.set_title(f"佐々総合病院 車20分圏内: 町丁目別 勢力圏（上位{TOP_N}施設のみで再計算）")
    ax3.axis("off")
    ...
    ax4.set_title("佐々総合病院 車20分圏内: 勢力圏（佐々総合病院 + 上位5施設で再計算）")
    ax4.axis("off")

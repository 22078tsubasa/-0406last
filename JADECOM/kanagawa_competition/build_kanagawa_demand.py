...
IN_CSV = Path("/Users/itotsubasa/Downloads/jadecom/4:6/神奈川/h03_14.csv")
OUT_CSV = BASE_DIR / "data" / "h03_14_町丁目別医療需要者数_main_with_age.csv"
...
def main() -> None:
    ...
    use = df[(df["都道府県名"] == "神奈川県") & (df["男女"] == "総数") & (df["地域階層レベル"] == 4)].copy()
